"""Quick sweep: 1200 steps, save every 100, find peak."""
...
def main():
    ...
    print("{} steps, saving every 100, CPU".format(total_steps))
    ...
    # Sweep
    print("\n" + "=" * 50)
    print("SWEEP: Evaluating all snapshots...")
    print("=" * 50)
    ...
    if best_snapshot and best_acc > acc_before:
        ...
        print("Saved best.pt from step {}: {:.1f}%".format(best_step, best_acc * 100))
